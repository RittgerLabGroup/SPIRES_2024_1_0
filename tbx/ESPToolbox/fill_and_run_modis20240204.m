...
%}
    ...
    outloc = [scratchPath, 'modis/intermediary/spiresfill_', ...
        ...
        '/v006/', regionName, '/', datestr(matdates(end),'yyyy'), '/'];
    ...
    for i=1:length(m)
        ...
        fname=fullfile(outloc,[nameprefix , '_', datestr(rundates(1),'yyyymm') '.mat']); % Seb 20240204
