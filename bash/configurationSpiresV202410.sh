...
# Script core.
########################################################################################
source env/.matlabEnvironmentVariablesSpiresV202410
...
scriptIdFilePathAssociations[spiFillC]="./bashSpiresV202410/runSpiresFill.sh"
scriptIdFilePathAssociations[spiSmooC]="./bashSpiresV202410/runSpiresSmooth.sh"
scriptIdFilePathAssociations[moSpires]="./bash/runUpdateMosaicWithSpiresData.sh"
scriptIdFilePathAssociations[scdInCub]="./bashSpiresV202410/runUpdateWaterYearSCD.sh"
